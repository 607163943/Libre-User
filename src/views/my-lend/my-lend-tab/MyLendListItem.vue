...
import type { MyLendTableData } from '@/types/lend'

const { book, handleRenew, handleReturn } = defineProps<{
  book: MyLendTableData
  handleRenew: (bookId: number) => void
  handleReturn: (bookId: number) => void
}>()
